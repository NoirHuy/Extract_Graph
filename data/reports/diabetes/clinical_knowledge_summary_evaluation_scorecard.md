...
**Tài liệu:** `clinical_knowledge_summary.csv` | **Tổng số bộ 3 tri thức:** `198`
**Điểm Chất Lượng Toàn diện:** **`88.99 / 100`** — **Xếp loại:** **B (Khá / Cần lưu ý vài điểm)**

## 📊 Bảng Điểm Thành Phần
| Hội đồng Chuyên môn | Điểm số (0-100) | Đạt chuẩn (Pass) | Cảnh báo (Warning) | Lỗi (Fail) |
|---|:---:|:---:|:---:|:---:|
| **Clinical Doctor Agent** | **72.47** | 126 | 25 | 47 |
| **UMLS Ontology Auditor Agent** | **100.0** | 198 | 0 | 0 |
| **Graph Structure Inspector Agent** | **100.0** | 198 | 0 | 0 |
